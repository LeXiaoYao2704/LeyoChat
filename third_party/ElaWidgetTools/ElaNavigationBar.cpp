    ...
    : QWidget{parent}, d_ptr(new ElaNavigationBarPrivate())
{
    ...
    d->_userCard->setCardPixmap(QPixmap(":/include/Image/DefaultAvatar.jpg"));
    ...
    d->_userButton = new ElaIconButton(QPixmap(":/include/Image/DefaultAvatar.jpg"), this);
