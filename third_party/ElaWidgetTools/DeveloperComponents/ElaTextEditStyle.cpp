...
ElaTextEditStyle::ElaTextEditStyle(QStyle* style)
{
    _pExpandMarkWidth = 0;
...
ElaTextEditStyle::~ElaTextEditStyle()
{
}

void ElaTextEditStyle::drawControl(ControlElement element, const QStyleOption* option, QPainter* painter, const QWidget* widget) const
{
    switch (element)
    {
